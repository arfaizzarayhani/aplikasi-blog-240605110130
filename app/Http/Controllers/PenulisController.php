...
class PenulisController extends Controller
{
    ...
    public function destroy(string $id)
    {
        ...
        try {
            // Mengamankan nama berkas foto sebelum baris database dihapus
            $foto = $penulis->foto;

            $penulis->delete();

            // Berkas fisik foto hanya dihapus jika database sukses dibersihkan
            if ($foto !== 'default.png') {
            ...
            // Mencegah error crash database jika user penulis masih terikat ke data artikel
